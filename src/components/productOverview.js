...
import ciimg1 from '../images/ciimg.png';
import ciimg2 from '../images/ciimg2.png';
import ciimg3 from '../images/ciimg3.png';
        ...
        <div className='productOverview-container'>
            ...
            <div className='content-container'>
                <div className='content-desc-container'>
                    ...
                    <p className='content-title'>Goals and Objectives</p>
                    ...
                    <div className='GO-container'>
                        <div className='GO-card'>
                            <img src={goalimg} alt='goal-img' className='go-img' />
                        ...
                        <div className='GO-card'>
                        <img src={objimg} alt='obj-img' className='go-img' />
                            ...
                            <ul>
                                ...
                                <li>Utilize LoRa wireless communication protocol for efficient and secure communication.</li>
                ...
                <div className='content-desc-container'>
                    ...
                    <div className='GO-container'>
                        <div className='GO-card'>
                            <img src={ciimg1} alt='ci-img' className='go-img' />
                            ...
                            <ul>
                                ...
                                <li>Reduced risk of accidents and crime around the area</li>
                                <li>Increased sense of security for the residents</li>
                            </ul>
                        </div>
                        <div className='GO-card'>
                            <img src={ciimg2} alt='ci-img' className='go-img' />
                        ...
                        <div className='GO-card'>
                            <img src={ciimg3} alt='ci-img' className='go-img' />
